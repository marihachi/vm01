...
int main(int argc, const char* argv[]) {
    ...
    uint8_t serialData[] = {
        ...
        0x40, 0x00, 0x00, 0x00, // 0x0040
        0x80, 0x00, 0x00, 0x00, // 0x0080
        0x00, 0x01, 0x00, 0x00, // 0x0100
    ...
    if (!Program_load(&program, &serialArray)) {
        return 1;
    }
